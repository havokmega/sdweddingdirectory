 ...
 * ---------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Couple_Dashboard_Plugin' ) && class_exists( 'SDWeddingDirectory_Config' ) ){

   /**
    *  SDWeddingDirectory - Couple Profile
    *  ---------------------------
    */
    class SDWeddingDirectory_Couple_Dashboard_Plugin extends SDWeddingDirectory_Config{
        ...
        private function files(){
             ...
             *  ------------
             */
            $_condition_1 = SDWeddingDirectory_Config:: is_couple();

            $_condition_2 = SDWeddingDirectory_Config:: dashboard_page_set( esc_attr( 'couple-dashboard' ) );
     ...
     *  ------------------------
     */
    SDWeddingDirectory_Couple_Dashboard_Plugin:: get_instance();
}