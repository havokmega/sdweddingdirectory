<?php
/**
 *  SDWeddingDirectory - Vendor Profile Database
 *  ------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Vendor_Profile_Database' ) && class_exists( 'SDWeddingDirectory_Form_Tabs' ) ){

    /**
     *  SDWeddingDirectory - Vendor Profile Database
     *  ------------------------------------
     */
    class SDWeddingDirectory_Vendor_Profile_Database extends SDWeddingDirectory_Form_Tabs{
         ...
         *  -----------------------
         */
        public static function get_vendor_social_media( $args = [] ){
     ...
     *  ------------------------------------
     */
    SDWeddingDirectory_Vendor_Profile_Database:: get_instance();
}