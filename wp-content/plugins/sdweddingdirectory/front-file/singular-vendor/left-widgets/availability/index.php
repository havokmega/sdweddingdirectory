<?php
/**
 *  SDWeddingDirectory - Vendor Left Widget: Availability
 *  -----------------------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Vendor_Singular_Left_Side_Widget_Availability' ) && class_exists( 'SDWeddingDirectory_Vendor_Singular_Left_Side_Widget' ) ){

    class SDWeddingDirectory_Vendor_Singular_Left_Side_Widget_Availability extends SDWeddingDirectory_Vendor_Singular_Left_Side_Widget{
        ...
        public function __construct() {
            ...
            add_action( 'sdweddingdirectory/vendor/singular/left-side/widget', [ $this, 'widget' ], absint( '25' ), absint( '1' ) );
        }
    ...
    SDWeddingDirectory_Vendor_Singular_Left_Side_Widget_Availability::get_instance();
}
