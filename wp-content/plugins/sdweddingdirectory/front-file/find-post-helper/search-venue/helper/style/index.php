 ...
 *  --------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Search_Result_Filter_Widget_Style' ) && class_exists( 'SDWeddingDirectory_Search_Result_Helper' ) ){

    /**
     *  SDWeddingDirectory Search Venue Helper
     *  --------------------------------
     */
    class SDWeddingDirectory_Search_Result_Filter_Widget_Style extends SDWeddingDirectory_Search_Result_Helper{
        ...
        public function __construct() {
             ...
             *  --------------
             */
            add_action( 'sdweddingdirectory/find-venue/filter-widget', [ $this, 'widget' ], absint( '68' ), absint( '1' ) );

            /**
             *  2. Have Active Filters ?
             *  ------------------------
             */
            add_filter( 'sdweddingdirectory/find-venue/active-filters', [ $this, 'active_filter' ], absint( '68' ), absint( '1' ) );
        }
        ...
        public static function widget( $args = [] ){
        	...
        	if( parent:: _is_array( $args ) ){
                ...
                $_have_lable     =   ! empty( $_have_lable ) ? $_have_lable : esc_attr__( 'Style', 'sdweddingdirectory' );
     ...
     *  --------------------
     */
    SDWeddingDirectory_Search_Result_Filter_Widget_Style::get_instance();
}
