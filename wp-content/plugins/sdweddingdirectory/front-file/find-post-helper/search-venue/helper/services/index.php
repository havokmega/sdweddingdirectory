 ...
 *  --------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Search_Result_Filter_Widget_Services' ) && class_exists( 'SDWeddingDirectory_Search_Result_Helper' ) ){

    /**
     *  SDWeddingDirectory Search Venue Helper
     *  --------------------------------
     */
    class SDWeddingDirectory_Search_Result_Filter_Widget_Services extends SDWeddingDirectory_Search_Result_Helper{
        ...
        public function __construct() {
             ...
             *  ------------------
             */
            add_action( 'sdweddingdirectory/find-venue/filter-widget', [ $this, 'widget' ], absint( '66' ), absint( '1' ) );

            /**
             *  2. Have Active Filters ?
             *  ------------------------
             */
            add_filter( 'sdweddingdirectory/find-venue/active-filters', [ $this, 'active_filter' ], absint( '66' ), absint( '1' ) );
        }
        ...
        public static function widget( $args = [] ){
        	...
        	if( parent:: _is_array( $args ) ){
	             ...
	             *  ------------
	             */
	            $_have_lable    	=   sdwd_get_term_field( sanitize_key( 'label_' . self:: widget_name() ), parent:: _cat_id() );

                $_have_lable     =   ! empty( $_have_lable ) ? $_have_lable : esc_attr__( 'Services', 'sdweddingdirectory' );
        ...
        public static function is_enable(){
            ...
            $enable_section =   sdwd_get_term_field( sanitize_key( 'enable_' . self:: widget_name() ), parent:: _cat_id() );

            $enable_filter  =   sdwd_get_term_field( sanitize_key( 'filter_widget_' . self:: widget_name() ), parent:: _cat_id() );

            return $enable_section && $enable_filter;
        }
        ...
        public static function options(){
            ...
            $options = apply_filters( 'sdweddingdirectory/term-box-group', [
                ...
                'slug'          =>  esc_attr( self:: widget_name() )
            ] );

            return parent:: _is_array( $options ) ? $options : [];
        }
    }
     ...
     *  --------------------
     */
    SDWeddingDirectory_Search_Result_Filter_Widget_Services::get_instance();
}
