 ...
 *  --------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Search_Result_Filter_Widget_Setting' ) && class_exists( 'SDWeddingDirectory_Search_Result_Helper' ) ){

    /**
     *  SDWeddingDirectory Search Venue Helper
     *  --------------------------------
     */
    class SDWeddingDirectory_Search_Result_Filter_Widget_Setting extends SDWeddingDirectory_Search_Result_Helper{
        ...
        public function __construct() {
             ...
             *  -----------------
             */
            add_action( 'sdweddingdirectory/find-venue/filter-widget', [ $this, 'widget' ], absint( '62' ), absint( '1' ) );

            /**
             *  2. Have Active Filters ?
             *  ------------------------
             */
            add_filter( 'sdweddingdirectory/find-venue/active-filters', [ $this, 'active_filter' ], absint( '62' ), absint( '1' ) );
        }
        ...
        public static function widget( $args = [] ){
        	...
        	if( parent:: _is_array( $args ) ){
	             ...
	             *  ------------
	             */
	            $_have_lable    	=   esc_attr__( 'Setting', 'sdweddingdirectory' );
	            ...
	            if( $layout == absint( '1' ) ){
		            ...
		            printf(	'<div class="col-12">
                                    ...
                                    <div class="checkbox-data venue-filter-data" data-handler="%2$s" data-type="single">
        ...
        public static function is_enable(){
            ...
            if( ! empty( $cat_id ) ){
                ...
                return      sdwd_get_term_field(
                                ...
                                sanitize_key( 'setting_available' ),
            ...
            if( parent:: _is_array( $parents ) ){
                ...
                foreach( array_keys( $parents ) as $term_id ){
                    ...
                    if( sdwd_get_term_field( sanitize_key( 'setting_available' ), $term_id ) ){
     ...
     *  --------------------
     */
    SDWeddingDirectory_Search_Result_Filter_Widget_Setting::get_instance();
}
