<?php
/**
 *  SDWeddingDirectory - Twitter Login / Registration
 *  -----------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Twitter_Login_Registration' ) && class_exists( 'SDWeddingDirectory_Social_Login_Registration' ) ) {

    /**
     *  SDWeddingDirectory - Twitter Login / Registration
     *  -----------------------------------------
     */
    class SDWeddingDirectory_Twitter_Login_Registration extends SDWeddingDirectory_Social_Login_Registration{
     ...
     *  -----------------------------------------
     */
    SDWeddingDirectory_Twitter_Login_Registration::get_instance();
}