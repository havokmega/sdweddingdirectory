<?php
/**
 *  SDWeddingDirectory - Google Login / Registration
 *  ----------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Google_Login_Registration' ) && class_exists( 'SDWeddingDirectory_Social_Login_Registration' ) ) {

    /**
     *  SDWeddingDirectory - Google Login / Registration
     *  ----------------------------------------
     */
    class SDWeddingDirectory_Google_Login_Registration extends SDWeddingDirectory_Social_Login_Registration {
     ...
     *  ----------------------------------------
     */
    SDWeddingDirectory_Google_Login_Registration::get_instance();
}