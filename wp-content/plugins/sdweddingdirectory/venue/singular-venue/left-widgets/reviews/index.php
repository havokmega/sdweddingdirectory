<?php
/**
 *  SDWeddingDirectory - Venue Left Widget: Reviews
 *  -----------------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Venue_Singular_Left_Side_Widget_Reviews' ) && class_exists( 'SDWeddingDirectory_Venue_Singular_Left_Side_Widget' ) ){

    class SDWeddingDirectory_Venue_Singular_Left_Side_Widget_Reviews extends SDWeddingDirectory_Venue_Singular_Left_Side_Widget{
        ...
        public function __construct() {
            ...
            add_action( 'sdweddingdirectory/venue/singular/left-side/widget', [ $this, 'widget' ], absint( '85' ), absint( '1' ) );
        }
        ...
        public static function widget( $args = [] ){
            ...
            $business_name = get_the_title( absint( $post_id ) );
    ...
    SDWeddingDirectory_Venue_Singular_Left_Side_Widget_Reviews::get_instance();
}
