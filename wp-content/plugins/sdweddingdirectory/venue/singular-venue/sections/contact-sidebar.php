<?php
/**
 * Venue Singular - Section: Message + Review Sidebar
 */
...
$default_message = esc_html__( "We were excited to find you on SD Wedding Directory! We'd love to get more information about your venue and availability.", 'sdweddingdirectory' );
?>
<div class="sd-profile-contact-sticky">
    <div class="sd-profile-message-card mb-3">
        <h4 class="sd-profile-message-title"><?php esc_html_e( 'Message venue', 'sdweddingdirectory' ); ?></h4>

        <form class="sd-profile-message-form" data-post-id="<?php echo esc_attr( $post_id ); ?>" data-post-type="venue">
            <div class="mb-2">
