<?php
/**
 * Venue Singular - Section 3: Photo Collage
 */
...
$fallback_image = get_template_directory_uri() . '/assets/images/venues-pop-out.png';
            ...
            <div class="col-lg-8">
                <div class="row g-2 sd-profile-collage">
                    <div class="col-lg-6 col-md-6">
                        <img src="<?php echo esc_url( $images[0] ); ?>" class="rounded-start" alt="<?php echo esc_attr( $business_name ); ?>">
                    </div>
                    <div class="col-lg-3 col-md-3 d-flex flex-column gap-2">
                        <img src="<?php echo esc_url( $images[1] ); ?>" alt="<?php echo esc_attr( $business_name ); ?>">
                        <img src="<?php echo esc_url( $images[2] ); ?>" alt="<?php echo esc_attr( $business_name ); ?>">
                    </div>
                    <div class="col-lg-3 col-md-3 d-flex flex-column gap-2">
                        <img src="<?php echo esc_url( $images[3] ); ?>" alt="<?php echo esc_attr( $business_name ); ?>">
                        <div class="position-relative w-100 flex-fill">
                            <img src="<?php echo esc_url( $images[4] ); ?>" class="rounded-end" alt="<?php echo esc_attr( $business_name ); ?>">
                            <a href="#section_venue_gallery" class="position-absolute bottom-0 end-0 m-2 btn btn-sm sd-profile-see-photos">
