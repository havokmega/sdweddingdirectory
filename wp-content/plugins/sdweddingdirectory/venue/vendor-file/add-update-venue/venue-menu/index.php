 ...
 *  ---------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Venue_Fields_Post_Menu' ) && class_exists( 'SDWeddingDirectory_Dashboard_Venue_Update' ) ){
     ...
     *  ---------------------------
     */
    class SDWeddingDirectory_Venue_Fields_Post_Menu extends SDWeddingDirectory_Dashboard_Venue_Update{
        ...
        public static function tab_name(){
            ...
            return      esc_attr__( 'Cuisine Offer', 'sdweddingdirectory-venue' );
        }
        ...
        public function __construct() {
             ...
             *  ----------
             */
            add_filter( 'sdweddingdirectory/add-update-venue/tabs', [ $this, 'tab_info' ], absint( '100' ), absint( '1' ) );
        }
        ...
        public static function tab_content(){
            ...
            parent:: create_section( array(
                ...
                'field'     =>   array(
                    ...
                    'title'       =>   esc_attr__( 'Cuisine Offer', 'sdweddingdirectory-venue' ),
            ...
            $_section_class         =   sanitize_html_class( 'venue_menu' );
            ...
            printf( '<div class="card-body %5$s %1$s-section %1$s">
                        ...
                        <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 %1$s" id="%1$s">%4$s</div>
                     ...
                     *  ----------------------------------
                     */
                    esc_attr__( 'Add New Menu', 'sdweddingdirectory-venue' ),
                    ...
                    ?   parent:: get_venue_menus( [ 'post_id' => absint( $post_id ) ] )
     ...
     *  ---------------------------
     */
    SDWeddingDirectory_Venue_Fields_Post_Menu::get_instance();
}