 ...
 *  ---------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Venue_Fields_Post_My_Team' ) && class_exists( 'SDWeddingDirectory_Dashboard_Venue_Update' ) ){
     ...
     *  ---------------------------
     */
    class SDWeddingDirectory_Venue_Fields_Post_My_Team extends SDWeddingDirectory_Dashboard_Venue_Update{
        ...
        public static function tab_name(){
            ...
            return      esc_attr__( 'My Team', 'sdweddingdirectory-venue' );
        }
        ...
        public function __construct() {
             ...
             *  ----------
             */
            add_filter( 'sdweddingdirectory/add-update-venue/tabs', [ $this, 'tab_info' ], absint( '80' ), absint( '1' ) );
        }
        ...
        public static function tab_content(){
            ...
            $_section_class     =       sanitize_html_class( 'venue_team' );
            ...
            parent:: create_section( array(
                ...
                'field'     =>   array(
                    ...
                    'title'       =>   esc_attr__( 'My Team', 'sdweddingdirectory-venue' ),
            ...
            printf( '<div class="card-body %1$s">
                     ...
                     *  ----------------------------------
                     */
                    esc_attr__( 'Add New Team', 'sdweddingdirectory-venue' ),
                    ...
                    ?   parent:: get_venue_team( [ 'post_id'  =>  absint( $post_id ) ] )
     ...
     *  ---------------------------
     */
    SDWeddingDirectory_Venue_Fields_Post_My_Team::get_instance();
}