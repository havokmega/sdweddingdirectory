<?php
/**
 *  SDWeddingDirectory - Real Wedding Details - Season Filters
 *  -------------------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Real_Wedding_Details_Season_Filters' ) && class_exists( 'SDWeddingDirectory_Real_Wedding_Left_Widget_Filter' ) ){

    /**
     *  SDWeddingDirectory - Real Wedding Details - Season Filters
     *  -------------------------------------------------
     */
    class SDWeddingDirectory_Real_Wedding_Details_Season_Filters extends SDWeddingDirectory_Real_Wedding_Left_Widget_Filter{
        ...
        public function __construct() {
            ...
            // add_action( 'sdweddingdirectory/couple/dashboard/real-wedding/left-widget', [ $this, 'widget' ], absint( '20' ) );
        }
        ...
        public static function taxonomy_name(){
            ...
            return      esc_attr( 'real-wedding-season' );
        }
        ...
        public static function widget_name(){
            ...
            return      esc_attr__( 'Season', 'sdweddingdirectory-real-wedding' );
        }
                    ...
                    <?php
                        ...
                        if( parent:: _is_array( $_icons ) ){
                            ...
                            printf( '<div class="card-body">%1$s</div>', 
                                 ...
                                 *  ---------------------------
                                 */
                                esc_attr__( 'Please update season taxonomy in real wedding post', 'sdweddingdirectory-real-wedding' )
                            );
                        }
     ...
     *  -------------------------------------------------
     */
    SDWeddingDirectory_Real_Wedding_Details_Season_Filters:: get_instance();
}