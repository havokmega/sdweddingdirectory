<?php
/**
 *  SDWeddingDirectory - Real Wedding Details - Color Filters
 *  -------------------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Real_Wedding_Details_Color_Filters' ) && class_exists( 'SDWeddingDirectory_Real_Wedding_Left_Widget_Filter' ) ){

    /**
     *  SDWeddingDirectory - Real Wedding Details - Color Filters
     *  -------------------------------------------------
     */
    class SDWeddingDirectory_Real_Wedding_Details_Color_Filters extends SDWeddingDirectory_Real_Wedding_Left_Widget_Filter{
        ...
        public function __construct() {
            ...
            // add_action( 'sdweddingdirectory/couple/dashboard/real-wedding/left-widget', [ $this, 'widget' ], absint( '10' ) );
        }
        ...
        public static function taxonomy_name(){
            ...
            return      esc_attr( 'real-wedding-color' );
        }
        ...
        public static function widget_name(){
            ...
            return      esc_attr__( 'Color', 'sdweddingdirectory-real-wedding' );
        }
        ...
        public static function target_js(){
            ...
            return      esc_attr( 'couple_real_wedding_select_color_filter' );
        }
        ...
        public static function widget(){
            ...
            <div class="wedding-details-popups col">
                ...
                <?php
                     ...
                     *  --------------
                     */
                    $_colors        =   self:: get_taxonomy_terms();
                     ...
                     *  --------
                     */
                    $_color         =   self:: get_term_color( $_term_id );
                    ...
                    if( ! empty( $_color ) ){
                         ...
                         *  -----------
                         */
                        printf( '<div class="couple-save-color-code">

                                    <i class="fa fa-3x fa-circle" id="%2$s-taxonomy-color" style="color:%1$s;" aria-hidden="true"></i>
                    ...
                    <?php
                        ...
                        if( parent:: _is_array( $_colors ) ){
                            ...
                            <ul class="list-unstyled">
                                <?php
                                    ...
                                    if( parent:: _is_array( $_colors ) ){
                                         ...
                                         *  --------------
                                         */
                                        foreach( $_colors as $term_id => $name ){

                                            printf( '<li>

                                                        <a href="javascript:">

                                                            <div    class="wedding-color-theme %1$s" 
                                                     ...
                                                     *  -------------
                                                     */
                                                    sprintf( 'style="background: %1$s;"',

                                                        self:: get_term_color( $term_id )
                                                    ),
                            ...
                            printf( '<div class="card-body">%1$s</div>', 
                                 ...
                                 *  ---------------------------
                                 */
                                esc_attr__( 'Please update color taxonomy in real wedding post', 'sdweddingdirectory-real-wedding' )
                            );
                        }
     ...
     *  -------------------------------------------------
     */
    SDWeddingDirectory_Real_Wedding_Details_Color_Filters:: get_instance();
}