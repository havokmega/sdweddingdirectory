...
/**
 * venue all previous siblings (until predicate hit).
 *
 * @param {Node} node
 * @param {Function} [optional] pred - predicate function
 */
...
/**
 * venue next siblings (until predicate hit).
 *
 * @param {Node} node
 * @param {Function} [pred] - predicate function
 */
...
(function ($) {
  ...
  $.extend( $.summernote.options, {
    ...
    cleaner: {
          ...
          /**
           *  Only tag removed mean : <h1> replace with <p>. content not removed
           *  ------------------------------------------------------------------
           *  Remove tags and keep the contents
           *  ---------------------------------
           */
          keepTagContents: [ 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'table', 'td', 'tr', 'th', 'div' ],

          /**
           *  If found this tag removed with content.
           *  ---------------------------------------
           *  Remove full tags with contents
           *  ------------------------------
           */
          badTags: [ 'hr', 'code', 'svg', 'small', 'strong', 'b', 'img', 'i', 'main', 'footer', 'header', 'section', 'a', 'button', 'span', 'option', 'br', 'input', 'select', 'label', 'form', 'applet', 'col', 'colgroup', 'embed', 'noframes', 'noscript', 'script', 'style', 'title'],

          /**
           *  Bad Attributes
           *  --------------
           */
          badAttributes: [  'method', 'autocomplete', 'enctype', 'bgcolor', 'border', 'height', 'cellpadding', 'cellspacing', 'lang', 'start', 'style', 'valign', 'width' ],
...
(function($) {
    ...
    var WeddingDir_Summry_Editor = {
        ...
        editor: function(){
             ...
             *  ---------------------------------
             */
            if( $('.summerynotes').length ){

                $('.summerynotes').map( function(i){

                    var _id                 =  '#' + $(this).attr('id'),

                        _placeholder_text   =  _is_empty( $( this ).attr( 'placeholder' ) )

                                            ?   $( this ).attr( 'placeholder' )

                                            :   '',

                        _height             =   _is_empty( $( this ).attr( 'data-height' ) )

                                            ?   $( this ).attr( 'data-height' )

                                            :   '200',

                        _length             =   _is_empty( $( this ).attr( 'data-limit' ) )
                        ...
                        $( _id ).summernote( {
                            ...
                            /**
                             *  ==========================================================================
                             *  https://github.com/summernote/summernote/issues/118#issuecomment-697206818
                             *  ==========================================================================
                             */
                            callbacks: {
                                ...
                                /**
                                 *  --------------------------------------------------------------------------
                                 *  https://github.com/summernote/summernote/issues/118#issuecomment-224971577
                                 *  --------------------------------------------------------------------------
                                 */
                                onKeyup: function (e) {
                                    ...
                                    var t           =   e.currentTarget.innerText,
                                        ...
                                        text_length =   text.replace(/(<([^>]+)>)/ig, "").replace(/( )/, " ").length,
                                ...
                                onPaste: function (e) {
                                    ...
                                    // /**
                                    //  *  https://stackoverflow.com/questions/30993836/paste-content-as-plain-text-in-summernote-editor#answer-49632024
                                    //  *  -------------------------------------------------------------------------------------------------------------
                                    //  */
                                    ...
                                    // if(all.length > _length) {

                                    //     document.execCommand('insertText', false, bufferText.trim().substring(0, _length - t.length));

                                    //     $( _id ).text(all.trim().substring(0, _length));
                            ...
                            /**
                             *  ---------------------------------------------------------------------------------------------
                             *  https://stackoverflow.com/questions/27527989/setting-max-length-in-summernote#answer-48425595
                             *  ---------------------------------------------------------------------------------------------
                             */
                            // callbacks: {
     ...
     *  ------------
     */
    window.WeddingDir_Summry_Editor    =   WeddingDir_Summry_Editor;

    /**
     *  Document Ready to Run script on browser
     *  ---------------------------------------
     */
    $(document).ready( function() {  WeddingDir_Summry_Editor.init(); } );
