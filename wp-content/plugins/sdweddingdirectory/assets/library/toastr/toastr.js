...
// Backward compatibility: core scripts still call `sdweddingdirectory_alert`.
if (typeof window !== 'undefined') {
	window.weddingdir_alert = weddingdir_alert;
	window.sdweddingdirectory_alert = weddingdir_alert;
}
