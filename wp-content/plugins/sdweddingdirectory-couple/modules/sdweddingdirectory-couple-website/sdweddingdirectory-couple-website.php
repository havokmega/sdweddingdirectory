 ...
 *  ---------------------------
 *
 *  @package     SDWeddingDirectory - Couple Website
 ...
 *  @wordpress-plugin
 *  -----------------
 *  Plugin Name:     SDWeddingDirectory - Couple Website
 *  Plugin URI:      https://www.sdweddingdirectory.com
 *  Description:     Couple Website plugin used for couple can easy to show own website for publicly
 *  Version:         1.0.0
...
/**
 *  -----------------------------------------
 *  SDWeddingDirectory - Couple Website Plugin Object
 *  -----------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Couple_Website_Plugin' ) ){
     ...
     *  -----------------------------------------
     */
    class SDWeddingDirectory_Couple_Website_Plugin {
         ...
         *  =============
         */
        const   SLUG        =       'sdweddingdirectory-couple-website';
        ...
        public function __construct() {
             ...
             *  ------------------------
             */
            add_action( 'plugins_loaded', [ $this, 'plugins_loaded' ], absint( '300' ) );
        }
        ...
        private function constant(){
             ...
             *  --------------
             */
            define( 'SDWEDDINGDIRECTORY_WEBSITE_VERSION', self:: VERSION );

            /**
             *  Plugin URL
             *  ----------
             */
            define( 'SDWEDDINGDIRECTORY_WEBSITE_VERSION_URL', plugin_dir_url( __FILE__ ) );

            /**
             *  Plugin DIR
             *  ----------
             */
            define( 'SDWEDDINGDIRECTORY_WEBSITE_VERSION_DIR', plugin_dir_path( __FILE__ ) );

            /**
             *  Plugin Library
             *  --------------
             */
            define( 'SDWEDDINGDIRECTORY_WEBSITE_VERSION_LIB', SDWEDDINGDIRECTORY_WEBSITE_VERSION_URL . '/assets/library/' );
        }
     ...
     *  -----------------------------------------
     */
    SDWeddingDirectory_Couple_Website_Plugin:: get_instance();
}
