 ...
 *  -------------------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Couple_Dashboard_Website_Bridesmaids' ) && class_exists( 'SDWeddingDirectory_Couple_Dashboard_Website' ) ){
     ...
     *  -------------------------------------------------
     */
    class SDWeddingDirectory_Couple_Dashboard_Website_Bridesmaids extends SDWeddingDirectory_Couple_Dashboard_Website{
        ...
        public function __construct() {
             ...
             *  ----------
             */
            add_filter( 'sdweddingdirectory/couple-wedding-website/tabs', [ $this, 'tab' ], absint( '70' ), absint( '1' ) );
        }
        ...
        public static function tab_name(){
            ...
            return      esc_attr__( 'Bridesmaids', 'sdweddingdirectory-couple-website' );
        }
        ...
        public static function tab_id(){
            ...
            return      esc_attr( 'couple_wedding_website_bridesmaids' );
        }
        ...
        public static function tab_content(){
                ...
                $_section_class     =   sanitize_html_class( 'couple_bride' );
                ...
                parent:: create_section( array(
                    ...
                    'field'    =>  array(
                        ...
                        'name'              =>  esc_attr( 'couple_bride_heading' ),

                        'id'                =>  esc_attr( 'couple_bride_heading' ),

                        'value'             =>  parent:: website_post_data( sanitize_key( 'couple_bride_heading' ) ),
                    )
                ...
                parent:: create_section( array(
                    ...
                    'field'    =>  array(
                        ...
                        'name'              =>  esc_attr( 'couple_bride_description' ),

                        'id'                =>  esc_attr( 'couple_bride_description' ),

                        'rows'              =>  absint( '3' ),

                        'value'             =>  parent:: website_post_data( sanitize_key( 'couple_bride_description' ) ),
                    )
                ...
                printf( '<div class="pb-3 pt-4 %1$s">
                         ...
                         *  ----------------------------------
                         */
                        esc_attr__( 'Add New Bride', 'sdweddingdirectory-couple-website' ),

                        /**
                         *  4. Data
                         *  -------
                         */
                        parent:: get_couple_bride( [ 'post_id' => parent:: website_post_id() ] )
                );
     ...
     *  -------------------------------------------------
     */
    SDWeddingDirectory_Couple_Dashboard_Website_Bridesmaids::get_instance();
}