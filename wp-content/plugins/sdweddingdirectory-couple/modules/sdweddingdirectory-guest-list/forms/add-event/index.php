...
if( ! class_exists( 'SDWeddingDirectory_Guest_List_Add_Event' ) && class_exists( 'SDWeddingDirectory_Guest_List_Form_Handler' ) ){
    ...
    class SDWeddingDirectory_Guest_List_Add_Event extends SDWeddingDirectory_Guest_List_Form_Handler{
        ...
        public static function sidebar_panel(){
            ...
            <div id="sdweddingdirectory_guest_event_sidepanel" class="sliding-panel">
        ...
        public static function load_form(){
            ...
            printf('<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    // 2
                    esc_attr__( 'Event Icon', 'sdweddingdirectory-guest-list' ),
            ...
            printf('<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">                
                        <div class="mb-3">
                            <div class=" form-light">
                                <input autocomplete="off" type="checkbox" class="form-check-input" id="%1$s" checked="" data-bs-toggle="collapse" data-bs-target="#event_have_mean_option" aria-expanded="true" aria-controls="event_have_mean_option">
                    ...
                    // 1
                    esc_attr( 'event_have_meal_option' ),
                    ...
                    <?php
                        ...
                        printf('<div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                          <button id="%3$s" class="btn btn-secondary btn-lg" type="button"><i class="fa fa-plus"></i></button>
                                    </div>
