 ...
 *  --------------------------
 *
 *  @package     SDWeddingDirectory - Request Quote
 ...
 *  @wordpress-plugin
 *  -----------------
 *  Plugin Name:     SDWeddingDirectory - Request Quote
 *  Plugin URI:      https://www.sdweddingdirectory.com
 *  Description:     Request Quote plugin using couple can easy to send request quote for venue vendor
 *  Version:         1.0.0
...
/**
 *  ----------------------------------------
 *  SDWeddingDirectory - Request Quote Plugin Object
 *  ----------------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Request_Quote_Plugin' ) ) {
     ...
     *  ----------------------------------------
     */
    class SDWeddingDirectory_Request_Quote_Plugin {
         ...
         *  =============
         */
        const   SLUG        =       'sdweddingdirectory-request-quote';
        ...
        public function __construct() {
             ...
             *  ------------------------
             */
            add_action( 'plugins_loaded', [ $this, 'plugins_loaded' ], absint( '180' ) );
        }
        ...
        private function constant(){
             ...
             *  --------------
             */
            define( 'SDWEDDINGDIRECTORY_REQUEST_QUOTE_PLUGIN', self:: VERSION );

            /**
             *  Plugin URL
             *  ----------
             */
            define( 'SDWEDDINGDIRECTORY_REQUEST_QUOTE_PLUGIN_URL', plugin_dir_url( __FILE__ ) );

            /**
             *  Plugin DIR
             *  ----------
             */
            define( 'SDWEDDINGDIRECTORY_REQUEST_QUOTE_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );

            /**
             *  Plugin Library
             *  --------------
             */
            define( 'SDWEDDINGDIRECTORY_REQUEST_QUOTE_PLUGIN_LIB', SDWEDDINGDIRECTORY_REQUEST_QUOTE_PLUGIN_URL . '/assets/library/');
        }
        ...
        private function files(){
             ...
             *  -----------
             */
            $this->files[]  =   'form-fields/index.php';
     ...
     *  ----------------------------------------
     */
    SDWeddingDirectory_Request_Quote_Plugin:: get_instance();
}
