 ...
 *  ---------------------
 *
 *  @package     SDWeddingDirectory - Wishlist
 ...
 *  @wordpress-plugin
 *  -----------------
 *  Plugin Name:     SDWeddingDirectory - Wishlist
 *  Plugin URI:      https://www.sdweddingdirectory.com
 *  Description:     Wishlist plugin using couple can easy to add venue in wishlist
 *  Version:         1.0.0
...
/**
 *  ----------------------------
 *  SDWeddingDirectory - Wishlist Object
 *  ----------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Wishlist_Plugin' ) ){
     ...
     *  ----------------------------
     */
    class SDWeddingDirectory_Wishlist_Plugin {
         ...
         *  =============
         */
        const   SLUG        =       'sdweddingdirectory-wishlist';
        ...
        public function __construct() {
             ...
             *  ------------------------
             */
            add_action( 'plugins_loaded', [ $this, 'plugins_loaded' ], absint( '110' ) );
        }
        ...
        private function sdweddingdirectory_hooks(){
             ...
             */
                ...
                /**
                 *  Wishlist AJAX nonce for authenticated couple actions
                 *  ---------------------------------------------------
                 */
                add_filter( 'sdweddingdirectory/localize_script', function( $args = [] ){
                    ...
                    $args['sdweddingdirectory_wishlist_security'] = wp_create_nonce( 'sdweddingdirectory_wishlist_security' );
        ...
        private function constant(){
             ...
             *  ----------------
             */
            define( 'SDWEDDINGDIRECTORY_WISHLIST_VERSION', self:: VERSION );
        }
        ...
        private function files(){
             ...
             *  -------
             */
            $this->files[]  = 'filter-hooks/index.php';
     ...
     *  ----------------------------
     */
    SDWeddingDirectory_Wishlist_Plugin:: get_instance();
}
