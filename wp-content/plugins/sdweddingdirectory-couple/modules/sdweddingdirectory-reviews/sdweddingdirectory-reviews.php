 ...
 *  --------------------
 *
 *  @package     SDWeddingDirectory - Reviews
 ...
 *  @wordpress-plugin
 *  -----------------
 *  Plugin Name:     SDWeddingDirectory - Reviews
 *  Plugin URI:      https://www.sdweddingdirectory.com
 *  Description:     Reviews plugin using couple can easy rating for venue and venue vendor can easy to show rating on vendor dashboard and venue singular page
 *  Version:         1.0.0
...
/**
 *  ---------------------------------
 *  SDWeddingDirectory - Review Plugin Object
 *  ---------------------------------
 */
if( ! class_exists( 'SDWeddingDirectory_Review_Plugin' ) ) {
     ...
     *  ---------------------------------
     */
    class SDWeddingDirectory_Review_Plugin {
         ...
         *  =============
         */
        const   SLUG        =       'sdweddingdirectory-reviews';
        ...
        public function __construct() {
             ...
             *  ------------------------
             */
            add_action( 'plugins_loaded', [ $this, 'plugins_loaded' ], absint( '200' ) );
        }
        ...
        private function constant(){
             ...
             *  --------------
             */
            define( 'SDWEDDINGDIRECTORY_REVIEW_PLUGIN', self:: VERSION );

            /**
             *  Plugin URL
             *  ----------
             */
            define('SDWEDDINGDIRECTORY_REVIEW_PLUGIN_URL', plugin_dir_url(__FILE__) );

            /**
             *  Plugin DIR
             *  ----------
             */
            define('SDWEDDINGDIRECTORY_REVIEW_PLUGIN_DIR', plugin_dir_path(__FILE__) );

            /**
             *  Plugin Library
             *  --------------
             */
            define('SDWEDDINGDIRECTORY_REVIEW_PLUGIN_LIB', SDWEDDINGDIRECTORY_REVIEW_PLUGIN_URL . '/assets/library/');
        }
        ...
        private function files(){
             ...
             *  ------------
             */
            $this->files[]      =       'assets/index.php';

            /**
             *  Singular Page Files
             *  -------------------
             */
            $this->files[]      =       'singular-file/index.php';

            /**
             *  Rating Post Layouts
             *  -------------------
             */
            $this->files[]      =       'rating-layout/index.php';
     ...
     *  ---------------------------------
     */
    SDWeddingDirectory_Review_Plugin:: get_instance();
}
