<?php
/**
 *    Template Name: Real Wedding Category
 *    ------------------------------------
 */
...
do_action( 'sdweddingdirectory_main_container' );
    ...
    if( class_exists( 'SDWeddingDirectory_Loader' ) ){
         ...
         *  ---------------
         */
        $parent_collection      =       apply_filters( 'sdweddingdirectory/tax/parent', 'real-wedding-category' );
        ...
        if( SDWeddingDirectory:: _is_array( $parent_collection ) ){
            ...
            foreach( $parent_collection as $key => $value ){
                 ...
                 *  --------------------------------------
                 */
                print class_exists( 'SDWeddingDirectory_Shortcode_Real_Wedding_Category' )
                    ? SDWeddingDirectory_Shortcode_Real_Wedding_Category::page_builder( [
                        'style'     => absint( '1' ),
