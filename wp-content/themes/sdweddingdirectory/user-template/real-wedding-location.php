<?php
/**
 *    Template Name: Real Wedding Location
 *    ------------------------------------
 */
...
do_action( 'sdweddingdirectory_main_container' );
    ...
    if( class_exists( 'SDWeddingDirectory_Loader' ) ){
         ...
         *  ---------------
         */
        $parent_collection      =       apply_filters( 'sdweddingdirectory/tax/parent', 'real-wedding-location' );
        ...
        if( SDWeddingDirectory:: _is_array( $parent_collection ) ){
            ...
            foreach( $parent_collection as $key => $value ){
                 ...
                 *  --------------------------------------
                 */
                print class_exists( 'SDWeddingDirectory_Shortcode_Real_Wedding_Location' )
