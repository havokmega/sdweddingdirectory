...
function sdwdv2_get_venue_filter_options( $filters ) {
    ...
    return [
        ...
        'price_ranges'    => sdwdv2_get_venue_range_options(
            ...
            $category_id,
            [
                [ 'min' => 1, 'max' => 2500, 'label' => __( '$1 - $2,500', 'sdweddingdirectory' ) ],
                [ 'min' => 2501, 'max' => 5000, 'label' => __( '$2,501 - $5,000', 'sdweddingdirectory' ) ],
                [ 'min' => 5001, 'max' => 10000, 'label' => __( '$5,001 - $10,000', 'sdweddingdirectory' ) ],
                [ 'min' => 10001, 'max' => 1000000, 'label' => __( '$10,001+', 'sdweddingdirectory' ) ],
            ],
            false
        ),
        ...
        'sorts'           => [
            'title-asc'  => __( 'Name: A to Z', 'sdweddingdirectory' ),
            'title-desc' => __( 'Name: Z to A', 'sdweddingdirectory' ),
            'newest'     => __( 'Newest', 'sdweddingdirectory' ),
            'price-low'  => __( 'Price: Low to High', 'sdweddingdirectory' ),
            'price-high' => __( 'Price: High to Low', 'sdweddingdirectory' ),
        ],
    ];
}
...
function sdwdv2_get_venue_starting_price( $post_id ) {
    ...
    if ( empty( $prices ) ) {
        return __( 'Custom pricing', 'sdweddingdirectory' );
    }
    ...
    return sprintf(
        ...
        __( 'Starting at $%s', 'sdweddingdirectory' ),
