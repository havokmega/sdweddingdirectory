...
function sdwdv2_get_vendor_filter_options( $filters ) {
    ...
    return [
        ...
        'sorts'        => [
            'title-asc'  => __( 'A to Z', 'sdweddingdirectory' ),
            'title-desc' => __( 'Z to A', 'sdweddingdirectory' ),
...
function sdwdv2_get_vendor_starting_price( $post_id ) {
    ...
    return __( 'Pricing available on request', 'sdweddingdirectory' );
}
...
function sdwdv2_get_vendor_overview_html( $post_id ) {
    ...
    if ( '' === trim( wp_strip_all_tags( $content ) ) ) {
        $content = sprintf(
            ...
            esc_html(
                sprintf(
                    __( '%s is part of the SD Wedding Directory vendor collection. Reach out for pricing, services, and availability details.', 'sdweddingdirectory' ),
