...
<div class="dashboard-wrapper">
    <div class="container">
        <h1 class="dash__title"><?php esc_html_e( 'Edit Your Profile', 'sdweddingdirectory' ); ?></h1>
        ...
        <form id="sdwd-dashboard-form" class="dash-form">
            ...
            <fieldset class="dash-section">
                ...
                <div class="dash-field">
                    <label for="sdwd_company_name"><?php esc_html_e( 'Company Name', 'sdweddingdirectory' ); ?></label>
