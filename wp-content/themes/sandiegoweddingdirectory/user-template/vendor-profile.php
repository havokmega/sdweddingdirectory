<?php
/**
 * Template Name: Vendor Profile (edit form)
 *
 * Assign this template to a `/vendor-dashboard/profile/` page so vendors
 * can edit their business info. The `/vendor-dashboard/` landing uses
 * user-template/vendor-dashboard.php (overview only).
 */
...
<div class="dashboard-wrapper">
    <div class="container">
        <h1 class="dash__title"><?php esc_html_e( 'Edit Your Profile', 'sandiegoweddingdirectory' ); ?></h1>
        ...
        <form id="sdwd-dashboard-form" class="dash-form">
            ...
            <fieldset class="dash-section">
                ...
                <div class="dash-field">
                    <label for="sdwd_company_name"><?php esc_html_e( 'Company Name', 'sandiegoweddingdirectory' ); ?></label>
