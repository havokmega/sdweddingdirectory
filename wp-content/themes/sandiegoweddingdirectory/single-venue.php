...
$address_parts = array_filter( [ $street, $city, 'CA', $zip ] );
        ...
        <div class="container">
            ...
            if ( $location ) {
                ...
                if ( ! is_wp_error( $loc_terms ) && ! empty( $loc_terms ) ) {
                    $breadcrumb_items[] = [
                        'label' => $loc_terms[0]->name,
                        'url'   => get_term_link( $loc_terms[0] ),
                    ];
                }
            }
            ...
            <div class="venue-profile-head__header">
                <div>
                    <?php if ( $type ) : ?>
                        <p class="venue-profile-head__eyebrow"><?php echo esc_html( $type ); ?></p>
                    <?php endif; ?>
                    <h1 class="venue-profile-head__title"><?php echo esc_html( $company ); ?></h1>
                    <div class="venue-profile-head__meta">
                        <?php if ( $location ) : ?>
                    ...
                    <?php if ( has_excerpt() ) : ?>
                        <p class="venue-profile-head__summary"><?php echo esc_html( get_the_excerpt() ); ?></p>
                    <?php endif; ?>
                </div>
        ...
        <div class="profile-layout">
            <div class="profile-main">
                ...
                <section class="profile-section" id="about">
                    ...
                    <?php // --- Venue Details (capacity, type, location) --- ?>
                ...
                <?php if ( $full_address ) : ?>
                    <section class="profile-section" id="map">
                        ...
                        <div class="profile-map">
                            <iframe
                                src="https://maps.google.com/maps?q=<?php echo esc_attr( urlencode( $full_address ) ); ?>&output=embed"
                                allowfullscreen
                                loading="lazy"
                                referrerpolicy="no-referrer-when-downgrade"
                                title="<?php echo esc_attr( $company ); ?>"
                            ></iframe>
                        </div>
                    </section>
                <?php endif; ?>
                        ...
                        <div class="venue-profile-tags__items">
                            <?php foreach ( $social_filtered as $link ) : ?>
                                <?php if ( ! empty( $link['url'] ) ) : ?>
                                    <a class="venue-profile-tags__item" href="<?php echo esc_url( $link['url'] ); ?>" target="_blank" rel="noopener noreferrer">
                                        <?php echo esc_html( $link['label'] ?: $link['url'] ); ?>
                                    </a>
                                <?php else : ?>
                                    <span class="venue-profile-tags__item"><?php echo esc_html( $link['label'] ); ?></span>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </div>
                    </section>
