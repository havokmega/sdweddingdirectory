...
<aside class="cd-widget cd-widget--rsvp">
    <h3 class="cd-widget__title">
        ...
        <?php esc_html_e( 'RSVP Tracker', 'sandiegoweddingdirectory' ); ?>
    </h3>

    <div class="cd-widget__soon">
        <?php esc_html_e( 'RSVP tracking opens when guest management is ready.', 'sandiegoweddingdirectory' ); ?>
    </div>

    <a href="<?php echo esc_url( home_url( '/couple-dashboard/guest-management/' ) ); ?>" class="cd-widget__link">
        <?php esc_html_e( 'Go to guest management', 'sandiegoweddingdirectory' ); ?> &rarr;
    </a>
</aside>
