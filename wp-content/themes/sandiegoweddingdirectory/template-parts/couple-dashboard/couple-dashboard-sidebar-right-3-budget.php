...
<aside class="cd-widget cd-widget--budget">
    <h3 class="cd-widget__title">
        ...
        <?php esc_html_e( 'Budget', 'sdweddingdirectory' ); ?>
    </h3>

    <?php if ( $total <= 0 ) : ?>
        <div class="cd-widget__soon">
            <?php esc_html_e( 'Set your wedding budget to start tracking.', 'sdweddingdirectory' ); ?>
        </div>
    <?php else : ?>
        <div class="cd-budget__totals">
            <span class="cd-budget__label"><?php esc_html_e( 'Spent', 'sdweddingdirectory' ); ?></span>
        ...
        <div class="cd-budget__totals">
            <span class="cd-budget__label">
                <?php echo $is_over ? esc_html__( 'Over budget', 'sdweddingdirectory' ) : esc_html__( 'Remaining', 'sdweddingdirectory' ); ?>
            </span>
    ...
    <a href="<?php echo esc_url( home_url( '/couple-dashboard/budget/' ) ); ?>" class="cd-widget__link">
        <?php esc_html_e( 'Manage budget', 'sdweddingdirectory' ); ?> &rarr;
    </a>
</aside>
