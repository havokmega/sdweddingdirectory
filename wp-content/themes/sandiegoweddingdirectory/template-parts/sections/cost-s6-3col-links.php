<?php
/**
 * Cost: 3-column inline links (no headings).
 */
...
?>
<section class="cost-s6-3col-links section" aria-label="<?php esc_attr_e( 'All cost guides', 'sandiegoweddingdirectory' ); ?>">
    <div class="container">
        <ul class="cost-s6-3col-links__list">
            <?php foreach ( $links as $link ) : ?>
                <li class="cost-s6-3col-links__item">
                    <a class="cost-s6-3col-links__link" href="<?php echo esc_url( $link['url'] ); ?>"><?php echo esc_html( $link['label'] ); ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </div>
