...
$items = [
    [
        'slug'  => 'privacy-policy',
        'label' => __( 'Privacy Policy', 'sdweddingdirectory' ),
        'url'   => home_url( '/privacy-policy/' ),
    ],
    [
        'slug'  => 'terms-of-use',
        'label' => __( 'Terms of Use', 'sdweddingdirectory' ),
        'url'   => home_url( '/terms-of-use/' ),
    ],
    [
        'slug'  => 'ca-privacy',
        'label' => __( 'CA Privacy', 'sdweddingdirectory' ),
        'url'   => home_url( '/ca-privacy/' ),
    ],
    [
        'slug'  => 'faqs',
        'label' => __( 'FAQ', 'sdweddingdirectory' ),
        'url'   => home_url( '/faqs/' ),
    ],
];
?>
<nav class="policy-subnav" aria-label="<?php esc_attr_e( 'Policy navigation', 'sdweddingdirectory' ); ?>">
