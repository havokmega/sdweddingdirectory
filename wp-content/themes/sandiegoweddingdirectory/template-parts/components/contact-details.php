...
<div class="contact-details">
    <div class="contact-details__grid grid grid--3col">
        <div class="contact-details__item">
            ...
            <h3 class="contact-details__label"><?php esc_html_e( 'Phone', 'sdweddingdirectory-v2' ); ?></h3>
        ...
        <div class="contact-details__item">
            <span class="contact-details__icon icon-building" aria-hidden="true"></span>
            <h3 class="contact-details__label"><?php esc_html_e( 'Address', 'sdweddingdirectory-v2' ); ?></h3>
            <p class="contact-details__value">
                <?php esc_html_e( 'San Diego, CA 92101', 'sdweddingdirectory-v2' ); ?>
            </p>
        </div>
        <div class="contact-details__item">
            <span class="contact-details__icon icon-envelope-o" aria-hidden="true"></span>
            <h3 class="contact-details__label"><?php esc_html_e( 'Inquiry', 'sdweddingdirectory-v2' ); ?></h3>
            <p class="contact-details__value">
